...
class ToDoTableViewController: UITableViewController, NSFetchedResultsControllerDelegate, ToDoItemDelegate, UIImagePickerControllerDelegate, UINavigationControllerDelegate, AnalyzeImageDelegate {
    
    @IBOutlet weak var tswiftImage: UIImageView!
    ...
    override func viewDidLoad() {
        ...
        let client = MSClient(applicationURLString: "https://dailynutritiontrails.azurewebsites.net")
        let managedObjectContext = (UIApplication.shared.delegate as! AppDelegate).managedObjectContext!
